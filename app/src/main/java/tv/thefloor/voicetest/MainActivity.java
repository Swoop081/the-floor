...
public class MainActivity extends Activity {
    private static final String GAME_URL = "https://swoop081.github.io/the-floor/voice-test.html?v=0.1.0";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(settings.getUserAgentString() + " TheFloorTV/0.1.0");
